      ...
      <div className={styles404.container404}>
        <div className={styles404.stars}>
          <div className={styles404.centralBody}>
            <img className={styles404.image404} src={Page404} width={300} />
            <Link
          ...
          <div className={styles404.objects}>
            <img className={styles404.object_rocket} src={Rocket} width={40} />
            <div className={styles404.earthMoon}>
              <img className={styles404.object_earth} src={Earth} width={100} />
              <img className={styles404.object_moon} src={Moon} width={80} />
            </div>
